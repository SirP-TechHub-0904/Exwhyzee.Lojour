...
Create PROCEDURE [dbo].[spListAllMembershipOfLearneredSociety]	
...
AS
	...
	SELECT *
	INTO #TempTableFiltered FROM [MembershipOfLearneredSociety] 
...
AND (@userProfileId IS NULL OR UserProfileId = @userProfileId)
	...
	--set table total
	SELECT @TotalCount = ISNULL(COUNT(Id),0) FROM [MembershipOfLearneredSociety] WITH(NOLOCK) 
