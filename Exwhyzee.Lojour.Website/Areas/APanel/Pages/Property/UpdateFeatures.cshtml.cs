...
namespace Exwhyzee.Lojour.Website.Areas.APanel.Pages.Property
{
    ...
    public class UpdateFeaturesModel : PageModel
    {
        ...
        public UpdateFeaturesModel(IPropertyAppService propertyAppService, IPropertyLandMarkAppService propertyLandMarkAppService,
        ...
        public async Task<IActionResult> OnPostFeatures(long id)
        {
            ...
            return RedirectToPage("./UpdateFeatures", new { id = id });
        }
