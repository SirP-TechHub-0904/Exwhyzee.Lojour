...
namespace Exwhyzee.Lojour.Website.Views.Shared.ViewComponents
{
    ...
    public class DefaultDetailImageFetcherViewComponent : ViewComponent
    {
        private readonly IPropertyImagesAppService _propertyImagesAppService;


        public DefaultDetailImageFetcherViewComponent(IPropertyImagesAppService propertyImagesAppService)
        {
