...
namespace Exwhyzee.Lojour.Website.Views.Shared.ViewComponents
{
    ...
    public class OtherDetailImageFetcherViewComponent : ViewComponent
    {
        private readonly IPropertyImagesAppService _propertyImagesAppService;


        public OtherDetailImageFetcherViewComponent(IPropertyImagesAppService propertyImagesAppService)
        {
